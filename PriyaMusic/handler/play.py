...
import aiofiles
import aiohttp
from PriyaMusic.converter import convert
import ffmpeg
import requests
...
from PriyaMusic.inline import stream_markup, audio_markup
...
async def play(c: Client, m: Message):
    ...
    try:
        ...
        b = await c.client_chat_member(chat_id, ubot)
        if b.status == "kicked":
            await m.reply_text(
    ...
    if replied:
        ...
        f"**🔍"
            ...
            if search == 0:
                ...
                info = f"https://t.me/SankiXMusicBot?start=info_{videoid}"
