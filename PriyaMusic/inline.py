from PriyaMusic.config import UPDATES_CHANNEL, GROUP_SUPPORT
...
def audio_markup(user_id):
  buttons = [
    [
      InlineKeyboardButton(text="● sᴜᴘᴘᴏʀᴛ ●", url=f"https://t.me/PriyaUpdates"),
      InlineKeyboardButton(text="● ᴜᴘᴅᴀᴛᴇs ●", url=f"https://t.me/PriyaUpdates"),
    ],
    [
