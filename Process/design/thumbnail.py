...
from PriyaMusic.config import YOUTUBE_IMG_URL
...
async def play_thumb(videoid):
    ...
    try:
        ...
        bg = Image.open(f"Process/assets/{images}.png")
        ...
        font = ImageFont.truetype("Process/assets/font2.ttf", 45)
        ImageFont.truetype("Process/assets/font2.ttf", 70)
        arial = ImageFont.truetype("Process/assets/font2.ttf", 30)
        ImageFont.truetype("Process/assets/font.ttf", 30)
